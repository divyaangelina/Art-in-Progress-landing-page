...
export function useThemeVars() {
  useEffect(() => {
    ...
    const vars = {
      ...
      "--shadow-frame-lit": theme.shadows.frameLit,
      "--shadow-glow-gold": theme.shadows.glowGold,
      "--shadow-glow-gold-strong": theme.shadows.glowGoldStrong,
      "--shadow-node-lit": theme.shadows.nodeLit,
      ...
      "--duration-reveal": theme.motion.duration.reveal,
      "--duration-drift": theme.motion.duration.drift,
      "--duration-ignite": theme.motion.duration.ignite,
      "--ease-standard": theme.motion.easing.standard,
      "--ease-enter": theme.motion.easing.enter,
      "--ease-exit": theme.motion.easing.exit,
      "--ease-curtain": theme.motion.easing.curtain,

      "--timeline-rail-width": theme.timeline.railWidth,
      "--timeline-rail-track": theme.timeline.railTrack,
      "--timeline-node-size": theme.timeline.nodeSize,
      "--timeline-node-size-current": theme.timeline.nodeSizeCurrent,
